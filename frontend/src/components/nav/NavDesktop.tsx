...
const NavDesktop = ({ items }: Props) => {
  ...
  const className = clsx(
    'pt-2 pb-3',
    isStart
      ? `absolute left-[4rem] z-10 top-4 flex bg-bb-blue-dark transform rotate-6
  ...
  after:block after:absolute after:h-full after:w-[90vw] after:right-0 after:top-0 after:transform after:translate-x-[99%] after:bg-bb-blue-dark`
      : `transform -rotate-2 absolute z-40 top-0 sm:top-[2vh] -right-1 flex bg-bb-blue-dark rounded-md`
  );
